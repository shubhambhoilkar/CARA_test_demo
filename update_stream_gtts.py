...
async def main():
    deepgram = DeepgramClient("996405495cba80ca40af769a18e9d99c6268479c6f")  # Replace with your key
    ...
    def check_interruption():        
        #check whether new voice is generated while audio playing
        player = AudioPlayer()
        r = sr.Recognizer()
...
#            return audio
            if r.recognize_google(audio) != None:
                player.pause()
                time.sleep(2)
                print("Received interruption: ", r.recognize_google(audio))            
